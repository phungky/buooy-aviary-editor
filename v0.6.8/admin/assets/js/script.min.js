jQuery(document).ready(function($){
	...
	$('body').on('mouseenter', '.mode-edit ul.attachments li .type-image', function(){
		...
		el += '<button class="btn-edit-image wharrf-edit-image mini ui primary button" style="margin-top:20px;">Image Editor</button>';
		el += '<button class="btn-edit-details js--select-attachment mini ui button" style="margin-top:20px;">Edit Details</button>';
		el += '</div>';
		$(this).append( el );
	});
	...
	var featherEditor = new Aviary.Feather({
		...
		onSave: function(imageID, newURL) {
			...
			tb_show( 'Save Image','#TB_inline?width=600&height=150&inlineId=save-image-thickbox' );
