...
Class Buooy_Aviary_Editor_Admin{
	...
	public function __construct(){
		...
		add_filter( 'plugin_action_links_'.BUOOY_AVIARY_EDITOR_BASE_NAME, array($this,'plugin_action_links'), 10, 5 );
	...
	public function submenu_page(){
		add_submenu_page( 'options-general.php', 'Buooy Aviary Editor Settings', 'Buooy Aviary Editor', 'manage_options', 'aviary_settings', array($this,'display') );
	}
	...
	public function plugin_action_links( $links ){
		$mylinks[] = '<a href="' . admin_url( 'options-general.php?page=aviary_settings' ) . '">Settings</a>';
